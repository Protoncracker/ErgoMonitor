...
def main():
    ...
    parser.add_argument('-a', '--add-back-links', nargs='?', const="[🔙 Back to ToC](#table-of-contents)", default=None, metavar='BACK_LINK_TEXT', help='Adds a custom "Back to ToC" link before each heading level 2 and beyond. If no argument is passed, uses the default "[🔙 Back to ToC](#table-of-contents)".')
    parser.add_argument('-r', '--remove-back-links', nargs='?', const="[🔙 Back to ToC](#table-of-contents)", default=None, metavar='BACK_LINK_TEXT', help='Removes all existing "Back to ToC" links from the README.md using the specified or default back link text.')
